...
const Navbar = () => {
  ...
  <ul tabIndex="-1" className="dropdown-content menu bg-[#413838f1] rounded-box z-1 w-[95vw] h-[40vh] mx-auto text-white p-2 shadow-sm items-center justify-center text-xl">
